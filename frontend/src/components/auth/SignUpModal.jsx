...
const SignUpModal = ({ isOpen, onClose, onSwitchToSignIn }) => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      toast.error(error.message || t('auth.messages.signUpError'))
    }
  }
    ...
    <Modal isOpen={isOpen} onClose={handleClose}>
      <div className="relative">
          ...
          <div>
            <Input
              ...
              {...register('name', {
                ...
                minLength: {
                  value: 2,
                  message: t('auth.validation.nameLength'),
                },
              })}
        ...
        <div className="flex items-center my-6">
          ...
          <span className="px-4 text-sm text-gray-400">{t('landing.hero.cta.or')}</span>
          <div className="flex-1 h-px bg-gray-600"></div>
        </div>
        ...
        <p className="text-center text-gray-400 mt-6">
          ...
          <button
            ...
            className="text-blue-2nd hover:text-blue-primary transition-colors font-medium"
          >
